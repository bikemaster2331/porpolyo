      ...
      <div className="max-w-7xl w-full flex-grow pt-4 md:pt-36">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:mb-20 mb-16">
          <div className="space-y-6 text-[12px] text-zinc-400 leading-relaxed font-sans">
            <p>
              I started coding during my first year of college, learned C++, C#, JS, coded on paper, made triangles using loops and conditions, and created CRUD systems. It was fun, but I didn't really take it seriously. <br />
              <br />
