            ...
            <a
              ...
              onClick={(e) => {
                if (!isDesktop) {
                  ...
                  // If already selected (hoveredIndex === i), allow the default Link behavior
                }
              }}
              className={`group relative p-3 md:p-8 flex flex-col transition-all duration-200 cursor-pointer ${project.gridSpan} 
